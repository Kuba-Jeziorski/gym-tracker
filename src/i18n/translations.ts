...
export const translations: Record<Locale, Record<string, string>> = {
  en: {
    ...
    titles_summary: "Summary",
    titles_weight: "Weight tracking",
    ...
    weight_description:
      "Log your body weight over time. You can add entries for today or any previous day.",
    weight_addHeading: "Add measurement",
    weight_dateLabel: "Date",
    weight_valueLabel: "Weight",
    weight_valuePlaceholder: "e.g. 78.5",
    weight_save: "Save",
    weight_pastDaysHint: "Pick a past date to backfill older measurements.",
    weight_invalidDate: "Choose a valid date that is not in the future.",
    weight_invalidWeight: "Enter a valid weight greater than 0.",
    weight_saveFailed: "Could not save this measurement.",
    weight_chartHeading: "Weight over time",
    weight_chartEmpty: "Add at least one measurement to see the chart.",
    weight_historyHeading: "History",
    weight_historyEmpty: "No measurements yet.",
    weight_delete: "Delete",
    weight_cancel: "Cancel",
    weight_deleteTitle: "Delete measurement?",
    weight_deleteMessage: "This measurement will be removed from your weight history.",
    ...
    dashboard_stat_trainingsThisWeek: "Trainings this week",
    dashboard_stat_setsThisWeek: "Sets this week",
    ...
    workout_removeExerciseConfirmTitle: "Remove exercise",
    workout_removeExerciseConfirmMessage: "Remove this exercise?",
    ...
    summary_description:
      "Completed trainings and sets for this week, this month, by period, and all time.",
    summary_empty: "No completed workouts yet.",
    summary_section_allTime: "All time",
    summary_stat_trainingsAll: "Trainings recorded",
    summary_stat_setsAll: "Sets logged",
    summary_section_thisWeek: "This calendar week",
    summary_stat_trainingsWeek: "Trainings this week",
    summary_stat_setsWeek: "Sets this week",
    summary_section_thisMonth: "This calendar month",
    summary_stat_trainingsMonth: "Trainings this month",
    summary_stat_setsMonth: "Sets this month",
    summary_byWeek: "By week",
    summary_byMonth: "By month",
    summary_column_period: "Period",
    summary_column_trainings: "Trainings",
    summary_column_sets: "Sets",
    summary_column_volume: "Volume (kg)",
    summary_charts_selectExercise: "Exercise",
    summary_charts_selectChartType: "Chart type",
    summary_charts_selectPlaceholder: "Select an exercise",
    summary_charts_emptyExercises: "No exercises with weight data yet.",
    summary_charts_emptyVolumeExercises:
      "No exercises with volume data yet.",
    summary_charts_emptyData: "No weight data for this exercise.",
    summary_charts_emptyVolumeData: "No volume data for this exercise.",
    summary_charts_typeMaxWeight: "Max weight",
    summary_charts_typeMaxVolume: "Max volume",
    summary_charts_maxWeightTitle: "Max weight over time",
    summary_charts_maxVolumeTitle: "Max volume over time",
    summary_charts_maxWeight: "Max weight",
    summary_charts_maxVolume: "Max volume",
    summary_charts_volumeUnitKg: "kg·reps",
    summary_charts_volumeUnitLb: "lb·reps",
  ...
  pl: {
    ...
    titles_summary: "Podsumowanie",
    titles_weight: "Śledzenie wagi",
    ...
    weight_title: "Śledzenie wagi",
    weight_description:
      "Zapisuj masę ciała w czasie. Możesz dodać wpis z dzisiaj lub z dowolnego wcześniejszego dnia.",
    weight_addHeading: "Dodaj pomiar",
    weight_dateLabel: "Data",
    weight_valueLabel: "Waga",
    weight_valuePlaceholder: "np. 78.5",
    weight_save: "Zapisz",
    weight_pastDaysHint: "Wybierz wcześniejszą datę, aby uzupełnić starsze pomiary.",
    weight_invalidDate: "Wybierz poprawną datę, która nie jest z przyszłości.",
    weight_invalidWeight: "Podaj poprawną wagę większą od 0.",
    weight_saveFailed: "Nie udało się zapisać pomiaru.",
    weight_chartHeading: "Waga w czasie",
    weight_chartEmpty: "Dodaj przynajmniej jeden pomiar, aby zobaczyć wykres.",
    weight_historyHeading: "Historia",
    weight_historyEmpty: "Brak pomiarów.",
    weight_delete: "Usuń",
    weight_cancel: "Anuluj",
    weight_deleteTitle: "Usunąć pomiar?",
    weight_deleteMessage: "Ten pomiar zostanie usunięty z historii wagi.",
    ...
    dashboard_stat_trainingsThisWeek: "Treningi w tym tygodniu",
    dashboard_stat_setsThisWeek: "Serie w tym tygodniu",
    ...
    workout_removeExerciseConfirmTitle: "Usuń ćwiczenie",
    workout_removeExerciseConfirmMessage: "Czy usunąć to ćwiczenie?",
    ...
    templates_moveUp: "Góra",
    templates_moveDown: "Dół",
    ...
    summary_description:
      "Ukończone treningi i serie: bieżący tydzień i miesiąc, podział na okresy oraz cała historia.",
    summary_empty: "Brak ukończonych treningów.",
    summary_section_allTime: "Cała historia",
    summary_stat_trainingsAll: "Zarejestrowane treningi",
    summary_stat_setsAll: "Zalogowane serie",
    summary_section_thisWeek: "Bieżący tydzień kalendarzowy",
    summary_stat_trainingsWeek: "Treningi w tym tygodniu",
    summary_stat_setsWeek: "Serie w tym tygodniu",
    summary_section_thisMonth: "Bieżący miesiąc kalendarzowy",
    summary_stat_trainingsMonth: "Treningi w tym miesiącu",
    summary_stat_setsMonth: "Serie w tym miesiącu",
    summary_byWeek: "Według tygodni",
    summary_byMonth: "Według miesięcy",
    summary_column_period: "Okres",
    summary_column_trainings: "Treningi",
    summary_column_sets: "Serie",
    summary_column_volume: "Objętość (kg)",
    summary_charts_selectExercise: "Ćwiczenie",
    summary_charts_selectChartType: "Typ wykresu",
    summary_charts_selectPlaceholder: "Wybierz ćwiczenie",
    summary_charts_emptyExercises: "Brak ćwiczeń z danymi o ciężarze.",
    summary_charts_emptyVolumeExercises:
      "Brak ćwiczeń z danymi o objętości.",
    summary_charts_emptyData: "Brak danych o ciężarze dla tego ćwiczenia.",
    summary_charts_emptyVolumeData: "Brak danych o objętości dla tego ćwiczenia.",
    summary_charts_typeMaxWeight: "Maks. ciężar",
    summary_charts_typeMaxVolume: "Maks. objętość",
    summary_charts_maxWeightTitle: "Maksymalny ciężar w czasie",
    summary_charts_maxVolumeTitle: "Maksymalna objętość w czasie",
    summary_charts_maxWeight: "Maks. ciężar",
    summary_charts_maxVolume: "Maks. objętość",
    summary_charts_volumeUnitKg: "kg·powt.",
    summary_charts_volumeUnitLb: "lb·powt.",
